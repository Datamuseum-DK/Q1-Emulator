...
jdc = {
    ...
    "pois" : {
        ...
        0x01fd: 'printer control - reset, raise ribbon',
        0x0201: 'printer status  - check result (1 == selected)',
        ...
        0x0299: 'display(SPC)',
        0x02a4: 'bit 3 set - 80 characters (LMC?)',
        0x02ab: 'bit 4 set - 40 characters (LITE?)',
        0x02ae: 'else      - 47 characters (LITE?)',
        0x0360: 'print character to Serial Impact Printer',
        ...
        0x18a2: 'get next instr or address',
        0x18a5: 'INST 0A - add',
        0x18a9: 'get next instr or address',
        0x18ac: 'INST 03 - store binary number at stack address',
        0x18b1: 'get next instr or address',
        ...
        0x18f8: 'get next instr or address',
        ...
        0x1bda: 'get next instr or address',
        ...
        0x1d3c: 'get next instr or address',
        ...
        0x1dc2: 'get next instr or address',
        0x1dc8: 'get next instr or address',
        0x1dcb: 'INST 02 - stack dec num from address on stack',
        0x1df5: 'call aaaa()',
        0x1df8: 'get next instr or address',
        0x1e24: 'INST 11 - divide decimal',
        0x1eb3: 'INST 0F - multiply decimal',
        0x1fb0: 'INST 34 - VERIFY',
        0x1fcc: 'get next instr or address',
        0x1fd8: 'get next instr or address',
        0x1fdb: 'INST 30 - string length',
        0x1fe4: 'get next instr or address',
        0x1ff8: 'jump via 0x4f to 0x734',
        0x1ff2: 'INST 35 - INDEX',
        0x1ffc: 'get next instr or address'
...
RTCTEST = {
    ...
    "data": [
            ["file", "roms/JDC/full.bin", 0x0000],
            ["snippet", [0xf3, 0x3e, 0x00, 0xd3, 0x0a, 0x3e, 0x00, 0xdb, 0x00, 0x3e],  0x4300],
            ["snippet", [0x10, 0xd3, 0x00, 0xdb, 0x00, 0xcb, 0x47, 0xca, 0x0d, 0x43],  0x430a],
            ["snippet", [0x3e, 0x05, 0xd3, 0x01, 0xdb, 0x01, 0xfe, 0x00, 0xca, 0x0d],  0x4314],
            ["snippet", [0x43, 0xe6, 0x0f, 0xf6, 0x10, 0xd3, 0x00, 0xc3, 0x0d, 0x43],  0x431e],

    ],
    "funcs" : [],
    "pois" : {
    0x430b: 'Enable clock (0x10), period = 1000ms',
    0x430f: 'check if timeout?',
